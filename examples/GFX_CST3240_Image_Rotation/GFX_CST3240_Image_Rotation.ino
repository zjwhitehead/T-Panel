 ...
 * @Description: 
        ...
        Enter the main interface, click the screen to start switching pictures and display 
    the coordinates, and press the BOOT button of ESP32S3 to switch the screen rotation angle.
 * @Author: LILYGO_L
 * @Date: 2023-09-15 15:41:30
 * @LastEditTime: 2024-07-20 16:29:39
 * @License: GPL 3.0
 */
